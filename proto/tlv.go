...
func (r *Tlv) write(length uint64, value uint64, out *[]byte) error {
...
func (r *Tlv) read(length uint64, input *[]byte) uint64 {
	switch length {
	case 2:
		return uint64(r.border.Uint16(*input))
	case 4:
		return uint64(r.border.Uint32(*input))
	case 8:
		return uint64(r.border.Uint64(*input))
	}
...
func (r *Tlv) ReadLength(bs *[]byte) (uint64, error) {
